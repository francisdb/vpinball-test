' Test: Contact (Williams 1978) Bigus MOD - VPinMAME wiring smoke test
'
' PinMAME table (cGameName="cntct_l1"); ROM owns ball/score state.
...
Dim TABLE_FILE          : TABLE_FILE          = "Contact (Williams 1978)_Bigus(MOD)1.0.vpx"
