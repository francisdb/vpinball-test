' Test: Vampirella - VPinMAME wiring smoke test
'
' PinMAME table (cGameName="drac_l1"); ROM owns ball/score state.
...
Dim EXTRACTED_TABLE_DIR : EXTRACTED_TABLE_DIR = TABLES_DIR & "\Vampirella (Original 2024)\Vampirella1 .3"
Dim TABLE_FILE          : TABLE_FILE          = "Vampirella1 .3.vpx"
