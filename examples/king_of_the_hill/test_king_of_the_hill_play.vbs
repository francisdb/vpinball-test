' Test: King of The Hill gameplay scenario - 3-ball drain
'
' LoadEM-style table (core.vbs). Ball saver is armed by Gate001_Hit
' (the gate between plunger lane and playfield), enabled for 20 s.
'
Option Explicit
...
For ball = 1 To 3
    ...
    tester.FireHit "Gate001"          ' arms BallSaverTimer (20 s)
