' Test: Clue (Original 2018) gameplay scenario
'
' Original 2018 with EndOfBall / EndOfBallComplete / EndOfGame state
...
Dim EXTRACTED_TABLE_DIR : EXTRACTED_TABLE_DIR = TABLES_DIR & "\Clue (Original 2018)\Clue-2.0-RC1"
Dim TABLE_FILE          : TABLE_FILE          = "Clue-2.0-RC1.vpx"
