' Test: Punk Park gameplay scenario - 3-ball drain
'
' LoadEM-style table (core.vbs). Ball saver is armed by Gate001_Hit
' (plunger-lane gate); BallSaverTime=15 s.
'
Option Explicit
...
Dim EXTRACTED_TABLE_DIR : EXTRACTED_TABLE_DIR = TABLES_DIR & "\Punk Park (Original 2025)\PunkPark"
Dim TABLE_FILE          : TABLE_FILE          = "PunkPark.vpx"
...
For ball = 1 To 3
    ...
    tester.FireHit "Gate001"          ' arms BallSaverTimer (15 s)
